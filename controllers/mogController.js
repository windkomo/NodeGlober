...
MogController.prototype.getMogs = function getMogs(callback) {
    mysql.getConnection(function(err, connection){
        connection.query(
        "SELECT u.mini_blog_name, BP.user_id, u.first_name, u.nick_name, u.last_name, occ.occupation_name, SUM(BP.views) AS total,"
        ...
        + " LEFT OUTER JOIN occupations occ ON occ.occupation_id = u.occupation_id"
